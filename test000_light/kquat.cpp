...
=====================
*//*
idAngles Quat::ToAngles( void ) const {
...
=====================
*//*
idRotation Quat::ToRotation( void ) const {
	Vec3 vec;
	float angle;
...
=====================
*/
idCQuat Quat::ToCQuat( void ) const {
	if ( w < 0.0f ) {
...
=============
*/
Mat3 idCQuat::ToMat3( void ) const {
...
=============
*/
Mat4 idCQuat::ToMat4( void ) const {
